...
import cinec.edu.carpertstoremmec.databinding.FragmentAddressBinding
import cinec.edu.carpertstoremmec.util.Resource
import cinec.edu.carpertstoremmec.viewmodel.AddressViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            buttonSave.setOnClickListener {
                ...
                val district = edState.text.toString()
