...
import cinec.edu.carpertstoremmec.databinding.FragmentProfileBinding
import cinec.edu.carpertstoremmec.util.Resource
import cinec.edu.carpertstoremmec.util.showBottomNavigationView
import cinec.edu.carpertstoremmec.viewmodel.ProfileViewModel
            ...
            viewModel.user.collectLatest {
                when(it){
                    ...
                    is Resource.Success ->{
                        ...
                        Glide.with(requireView()).load(it.data!!.imgPath).error(ColorDrawable(
                            Color.BLACK)
