...
import cinec.edu.carpertstoremmec.databinding.AddressRvItemBinding
    ...
    inner class AddressViewHolder(val binding: AddressRvItemBinding):
        ...
        fun bind(address: Address, isSelected: Boolean) {
            binding.apply {
                ...
                if (isSelected){
                    buttonAddress.background = ColorDrawable(itemView.context.resources.getColor(R.color.g_red))
                }else{
                    buttonAddress.background = ColorDrawable(itemView.context.resources.getColor(R.color.g_light_red))
                }
            }
        }
